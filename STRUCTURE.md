# Структура проекта — лендинг «Международные партнёры»

В проекте Yii 3 и функционал лендинга (заявки на сотрудничество). Корень репозитория — папка проекта (например `landing_sku`).
...
- **public/** — `index.php`, статика: `public/css/` (`design-system.css`, `landing.css`, `admin*.css`, …), `public/uploads/` (логотипы, загруженные файлы).
